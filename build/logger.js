        ...
        switch (this.options.logFormat) {
            case "json": {
                loggingFunction(JSON.stringify({
                    ...
                    msg: (0, normalizer_1.normalizeValue)(item, [], true),
                    description,
                    extra,
                }));
                break;
            ...
            case null: {
                ...
                loggingFunction(tag, ...(description === undefined ? [] : [description]), ...(normalizedContext === undefined
                    ? []
                    : ["~@ Context:", normalizedContext]), ...(extra.length === 0 ? [] : ["~@ Extra:", (0, normalizer_1.normalizeValue)(extra)]), (0, normalizer_1.normalizeValue)(item, [], true));
                break;
            }
            default: {
