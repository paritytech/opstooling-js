...
export declare const getOctokit: ({ logger, apiEndpoint, requestMutex: inputRequestMutex, }: {
    logger: Logger;
...
} & import("@octokit/plugin-rest-endpoint-methods/dist-types/generated/method-types").RestEndpointMethods & import("@octokit/plugin-rest-endpoint-methods/dist-types/types").Api) | undefined) => ExtendedOctokit;
export {};
