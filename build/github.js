...
const getOctokit = ({ logger, apiEndpoint, requestMutex: inputRequestMutex, }, octokit) => {
    octokit ??= new rest_1.Octokit({
        ...endpoint_1.endpoint.DEFAULTS,
    ...
    */
    ...
    Object.assign(octokit.repos, {
        ...
        getById: octokit.request.defaults({
            method: "GET",
            url: api_1.githubApiEndpoints.repositoryById,
        }),
    });
    Object.assign(octokit.pulls, {
        ...
        getByRepositoryId: octokit.request.defaults({
            method: "GET",
            url: api_1.githubApiEndpoints.pullRequestByRepositoryId,
        }),
    });
